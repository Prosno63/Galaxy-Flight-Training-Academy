 ...
 * @author tasin
 */
public class UpdateEmployeeSalaryInfoController implements Initializable {

    @FXML
    private TableView<?> EmployeeSalaryTable;
    @FXML
    private TableColumn<?, ?> EmployeeNameCollum;
    @FXML
    private TableColumn<?, ?> SalaryAmountCollum;
    @FXML
    private TableColumn<?, ?> StatusCollum;
